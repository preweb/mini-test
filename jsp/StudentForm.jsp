...
<!--                <form method="POST" class="search_form">
		...
		<h2><span>Student Personal Information Form</span></h2>
                <hr>
        </section>
...
<!--                <div class="control-group">
                ...
                <div class="control-group">
                    <label class="control-label" for="inputGdName">Guardian Name: <sup>*</sup></label>
                    <div class="controls">        
                        <input type ="text" name="guardianName" id="inputGdName" placeholder="Guardian Name" class="input-xlarge" required="">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="inputGdPh">Guardian Phone: <sup>*</sup></label>
                    <div class="controls">        
                        <input type ="text" name="guardianPh" id="inputGdPh" placeholder="Guardian Phone Number" class="input-xlarge" required="">
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    <label class="control-label">Grade: <sup>*</sup></label>
                    <div class="controls">        
                       <select required="" name="grade" class="input-xlarge">
                            <option value="" hidden>--Select--</option>
                            <option value="#">Option 1</option>
                            <option value="#">Option 2</option>
                            <option value="#">Option 3</option>
